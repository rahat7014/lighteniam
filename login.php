        ...
        <section class="form-area">
            <div class="container">
                <div class="form-body">
                    ...
                    <?php if($invalid){ echo '<div class="alert alert-danger" role="alert"> Invalid
                    Email or password! Please Check or Sign Up again </div>'; } ?>
                    <!-- ALART -->
                    <form method="post" action="login.php">
                        <div class="row">
                            <div class="col-lg-6 fmb-24">
                                <input
                                    type="email"
                                    name="email"
                                    class="form-control"
                            ...
                            <div class="col-lg-6 fmb-24">
                                ...
                                <a class="action-text" href="recover-password.php">Forget Password</a>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <a class="action-text" href="registration.php">Create Account</a>
                            </div>
                        </div>
                    </form>
                </div>
